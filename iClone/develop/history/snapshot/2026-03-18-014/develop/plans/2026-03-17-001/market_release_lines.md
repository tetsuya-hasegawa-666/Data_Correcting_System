...
| MRL-7 | completed | sync-first copy experience line | mobile / desktop を copy-first の共通 UX に再設計し、`Local / PC / PC synced` 表現、自動保存、写真付き同期、簡潔な end-user workspace を統一した |
