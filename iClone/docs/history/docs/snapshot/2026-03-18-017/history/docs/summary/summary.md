...
## 2026-03-18-017 end-user workspace and adb sync reflection

- PC preview を host console から end-user workspace へ切り替えた
- Android app に JS bridge、auto-save、photo attachment、workspace/history の実保存経路を追加した
- `adb_bridge.py` を追加し、Xperia 5 III の local files から host inbox へ pull、question / ack を device 側へ push する current route を source-of-truth に反映した
