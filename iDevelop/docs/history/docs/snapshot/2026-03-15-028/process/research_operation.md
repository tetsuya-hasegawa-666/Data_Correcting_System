...
| `TDD-13-1` | `shared-session-state` | `tests/shared-core/dashboardController.test.ts` | shared prompt / history の failing test を次 slice の入口にする | STORY_DEFINED | next micro release |
