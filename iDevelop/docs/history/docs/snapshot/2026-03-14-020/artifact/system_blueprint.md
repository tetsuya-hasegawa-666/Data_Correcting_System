...
- phase 3: 完了
- phase 4: 未着手
- current target: `2026-03-14-004 / MRL-8 / mRL-8-1`

## Next Design Focus

- code/script roots を generic contract に接続する
- code workspace を live source の read-only browse へ広げる
- pilot setup / rollback / evidence export を閉じる
