...
## Current TDD Task Set For `MRL-10`
...
| `TDD-11-1` | `document-bundle-fixed` | `tests/document-workspace/documentWorkspaceController.test.ts` | 複数文書選択 bundle の failing test を次 slice の入口にする | STORY_DEFINED | next micro release |
