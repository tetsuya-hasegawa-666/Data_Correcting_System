...
- current target: `MRL-12 / mRL-12-1`

## Continuation Rule

- current target を green にしたら、同一 `MRL-12` 内の次 micro release へ続けて進む。
- `MRL-12` を閉じる前に handoff へ切り替えない。
- 停止条件は user block、追加データ待ち、承認待ち、または 6 時間上限到達だけに限定する。
