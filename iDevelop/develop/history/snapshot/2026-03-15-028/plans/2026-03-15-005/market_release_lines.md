...
- `MRL-20` closes the current preview expression refinement line
- consultation and draft now explain purpose, effect, and source impact in the same visual structure
- read-only unlock remains explicit and now reads as part of the draft story

## Current Recommendation

- `2026-03-15-005` is completed through `MRL-20`
