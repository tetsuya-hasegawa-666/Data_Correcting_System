...
|---|---|---|---|
| MRL-10 | Interaction Contract Line | consultation session、input bundle、response contract、approval state を定義する | planned |
| MRL-11 | Document Consultation Line | 文書を選んで Codex に相談し、根拠付き応答を受け取れる | planned |
| MRL-12 | Data Consultation Line | データを選んで Codex に相談し、要約・確認ポイント・次 action を得られる | planned |
