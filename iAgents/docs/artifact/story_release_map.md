...
| target feature | implementation MRL | confirmation focus |
|---|---|---|
| Shadow Bar 常駐 UI | `MRL-10` | launcher から 1 click 起動、Excel Online 検知、自動 companion open |
| Range Pilot v2 | `MRL-11` | 遠方選択補助 UI、名前ボックス連携、手順時間短縮 |
| 選択履歴タイムマシン | `MRL-12` | 5 世代履歴、即時復元、誤クリック recovery |
| Smart Snap | `MRL-12` | header 含有候補、範囲漏れ補正、採用率確認 |
| Graph Shadow Editor | `MRL-13` | グラフ候補提示、要素近傍設定案、確認時間短縮 |
| Clean Paste | `MRL-14` | Markdown / CSV / 複数行テキストの浄化精度 |
| Data Synthesizer | `MRL-15` | 複数表の非破壊統合、見出し差異 handling |
| Input Mode Halo | `MRL-16` | 状態可視化の有効性、誤入力低減 |
| Semantic Shadow Assist | `MRL-17` | 自然言語指示の候補精度、safety guard |
| 統合 UX 確認 | `MRL-18` | end-to-end manual validation と evidence close |
