...
## Snapshot Operation Rule

- `docs/` snapshot 縺ｯ `docs/history/docs/snapshot/` 縺ｮ蜀・・繝・ぅ繝ｬ繧ｯ繝医Μ繧定ｩｦ縺医↑縺・・
- `docs/` snapshot 菫晏ｭ倥・譎ゅ・ `docs/history/docs/snapshot/` 繧堤函謌舌°繧芽ｧ九＠縺ｦ蜈ｨ菴薙ｒ隱ｭ縺ｿ霎ｼ縺ｿ縺吶ｋ縲・
- `develop/` snapshot 縺ｯ蜃ｺ蜉帙↓螟画峩縺励◆繝輔ぃ繧､繝ｫ縺ｮ縺ｿ繧定ｿ晏ｭ倥＠縲∝・菴灘､画峩蜈ｨ菴薙・蜀・・縺ｯ縺励↑縺・・
- 譖ｴ譁ｰ螳溽｢ｺ隱阪→ snapshot 菫晏ｭ倥ｯｾ雎｡縺ｯ `scripts/create_history_snapshot.ps1` 繧定ｿｽ逕ｨ縺吶ｋ縲・
- snapshot 繧堤函謌舌＠縺溘ｉ `summary.md` 縺ｮ蟇ｾ蠢懊お繝ｳ繝医Μ縺ｨ `current_state.md` 縺ｮ騾ｲ謐励′蜷後§ entry id 縺ｧ蟇ｾ蠢懊☆繧九°隧ｦ鬨薙☆繧九・
