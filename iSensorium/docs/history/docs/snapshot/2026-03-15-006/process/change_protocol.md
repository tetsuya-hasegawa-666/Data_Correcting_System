...
## User Preparation Routing

- user action、外部 device access、手動準備は `USER_PREPARATION.md` を source-of-truth とする
- `docs/process/UX_check_work_flow.md` には評価手順だけを書き、準備本文を重複記載しない
- 実 blocker が発生したときだけ、必要な user-side task を `USER_PREPARATION.md` に追加する
...
## Continuation Interpretation Rule
