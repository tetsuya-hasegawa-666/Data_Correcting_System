...
- 利用者準備、外部 device access、手動前提は `C:/Users/tetsuya/playground/Data_Correcting_System/iSensorium/USER_PREPARATION.md` を source-of-truth とする
- この文書には UX 評価手順だけを書き、準備本文は重複記載しない
...
利用者準備そのものは `USER_PREPARATION.md` を先に確認する。
