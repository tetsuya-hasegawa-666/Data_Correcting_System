...
| DocsSummary | `docs/history/docs/summary/README.md` | docs 全体の要約履歴 | 記録単位、命名規則、要約形式 | 履歴の追加 |
...
6. `docs/` 内の意味体系に関わる変更を行ったら、`docs/history/docs/summary/` に要約履歴を 1 件追加する。
...
- docs 全体の要約履歴は `docs/history/docs/summary/` だけに置く。
