...
- `iDevelop/` を companion project として分離して扱う境界ルール defined
...
- sibling project 分離直後のため、`iSensorium` 側と `iDevelop/` 側の規約混線が起きないか監視が必要
...
- `iDevelop/` のローカル規約と plan set が、`iSensorium` 側の分離境界ルールと矛盾しないか確認する
