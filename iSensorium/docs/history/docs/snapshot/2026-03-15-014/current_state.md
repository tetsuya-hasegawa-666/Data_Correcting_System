...
- 次:
  - `mRL-10-1` で recorder side preview tap を追加する。
  - `mRL-10-2` で replacement route recording 中だけ UI preview を guarded に出す。
  - `mRL-10-3` で Xperia 5 III 実機確認と docs / history 更新を閉じる。
- blocker:
