...
- Current state:
  - `MRL-6` completed as preparation line.
  - next implementation work should start from a new dated plan set that performs actual replacement runtime wiring behind the already-fixed seam.
