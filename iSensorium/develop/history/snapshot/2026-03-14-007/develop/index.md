...
このディレクトリは、`docs/` で定義された意味体系と運用規約に従って、`iSensorium` の実開発計画と履歴を管理する。
...
8. `iDevelop/` の feature 計画、実装履歴、検証記録は `../iDevelop/develop/` 配下で管理する。

## Active Plan Set

- current: `develop/plans/2026-03-14-006/`
- status: active and under implementation
- reason: `MRL-0 -> MRL-1` の最小 recording spine 実装をこの plan set に揃えて進めている
