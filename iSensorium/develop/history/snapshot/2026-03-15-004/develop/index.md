...
- active dated plan set: `develop/plans/2026-03-15-004/`
- active market release target: `MRL-6 guarded upstream trial`
- active micro release target: `mRL-6-1 adapter seam with frozen fallback`
- interpretation:
  - `2026-03-14-006` remains the historical validated baseline.
  - `2026-03-15-004` is the current execution plan for guarded upstream trial preparation inside `iSensorium`.
- hard guardrails:
