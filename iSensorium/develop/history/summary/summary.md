...
- change_summary: `docs/process/windows_beginner_test_manual.md` を追加し、`README.md` から直接辿れるようにした
- affected_documents: `docs/process/windows_beginner_test_manual.md`, `README.md`, `docs/history/docs/summary/summary.md`, `develop/history/summary/summary.md`
